...
export default function ChooseParameters() {
    ...
    return (
        <>
            <select 
                className={styles.select1Item + ' ' + styles.item + ' ' + styles.my_select} 
            ...
            <select 
                className={styles.select2Item + ' ' + styles.item + ' ' + styles.my_select} 
                value={selectedD} 
            ...
            <select 
                className={styles.select3Item + ' ' + styles.item + ' ' + styles.my_select} 
                value={selectedP} 
            ...
            <select 
                className={styles.select4Item + ' ' + styles.item + ' ' + styles.my_select} 
                value={apc} 
