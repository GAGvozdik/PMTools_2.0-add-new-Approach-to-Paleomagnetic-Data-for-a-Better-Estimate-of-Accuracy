...
const cacPage = createSlice({
  ...
  reducers: {
    ...
    toggleCommentsInput(state) {
      ...
      localStorage.setItem('cacPage_isCommentsInputVisible', JSON.stringify(state.isCommentsInputVisible));
    },
    ...
    addInterpretation (state, action) {
      ...
      localStorage.setItem('cacPage_allInterpretations', JSON.stringify(state.allInterpretations));
      localStorage.setItem('cacPage_currentInterpretation', JSON.stringify(state.currentInterpretation?.label || ''));
    },
    ...
    deleteAllInterpretations (state) {
      ...
      localStorage.setItem('cacPage_allInterpretations', JSON.stringify(state.allInterpretations));
      localStorage.setItem('cacPage_currentInterpretation', JSON.stringify(''));
    },
...
const cacPageReducer = cacPage.reducer;
export default cacPageReducer;